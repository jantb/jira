...
func Test_cosine_similarity(t *testing.T) {
	...
	if similarity(tfidf[data13], tfidf[data12]) != 0.45372336879546316 {
		t.Error("Expected similarity(tfidf[data], tfidf[data2]) to be 0 was", similarity(tfidf[data12], tfidf[data13]))
	}
